...
class ProviderRuntime:
    ...
    planner_model: str
    rerank_model: str
    x_search_backend: Literal["xai", "bird", "hermes_tweet"] | None = None
...
@dataclass
class TokenRef:
    """Stub retained for schema compatibility. Not used in pulse."""
...
class Report:
    ...
    # Retained for schema compatibility; always empty in pulse.
